...
pri16 psGpPrio;                 /* PS Group Priority                    */
pri16 tsGpPrio;                 /* TS Group Priority                    */

pri16 initPsPrio;               /* PS Group Initial Priority            */
pri16 initTsPrio;               /* TS Group Initial Priority            */
...
static	void	sysinit(void)
{
	...
	/* Scheduling is not currently blocked */
        ...
        /* Defining initial group priority for PS and TS Group */
	initPsPrio = 10;
	initTsPrio = 10;
	psGpPrio = initPsPrio;
	tsGpPrio = initTsPrio;
