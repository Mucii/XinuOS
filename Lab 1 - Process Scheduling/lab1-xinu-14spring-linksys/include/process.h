...
struct procent {		/* entry in the process table		*/
	...
	pri16   prPsRate;       /* proportional scheduler rate          */
	uint32  prStartTime;    /* process start time                   */
	int     prGroup;        /* process scheduling group             */
	pri16   prPsPrio;       /* priority PS group                    */
	int16   isBlocked;      /* if the process executes after being blocked */
};
